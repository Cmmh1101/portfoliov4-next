...
const TechWithIcons: React.FC<{ technologies: string[] | undefined }> = (
  ...
  const iconClasses =
    "text-black bg-white mx-auto mb-3 text-5xl rounded-md group-hover:-rotate-45 duration-1000 p-1 group-hover:bg-blue-400";
  const pClasses =
        ...
        return (
          <div key={i} className="w-28 my-3 text-center group">
            {tech.toLowerCase() === "css" ? (
              ...
              <>
                <SiJavascript className="text-white bg-black mx-auto mb-3 text-5xl rounded-md group-hover:-rotate-45 duration-1000 group-hover:text-blue-400" />
                <p className={pClasses}>{tech}</p>
              </>
              ...
              <>
                <SiTypescript className="text-white bg-black mx-auto mb-3 text-5xl rounded-md group-hover:-rotate-45 duration-1000 group-hover:text-blue-400" />
                <p className={pClasses}>{tech}</p>
              </>
