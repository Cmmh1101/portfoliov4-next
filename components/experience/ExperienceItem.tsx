  ...
  return (
      <div>
          <div className='flex items-center'>
              {experience?.image && <Image src={experience?.image!} alt='' width={100} height={100} className='mr-3 rounded-md' style={{objectFit: 'cover', objectPosition: 'center', maxHeight: "100px"}} />}
